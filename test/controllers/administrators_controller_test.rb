...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { email: @administrator.email, password_digest: @administrator.password_digest, username: @administrator.username } }, as: :json
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { email: @administrator.email, password_digest: @administrator.password_digest, username: @administrator.username } }, as: :json
    assert_response 200
  end
